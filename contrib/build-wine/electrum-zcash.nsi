...
;Variables
  ...
  !define PRODUCT_NAME "Zcash Electrum"
  !define PRODUCT_NAME_NO_SPACE "Zcash-Electrum"
  !define PREV_PROD_NAME "Electrum-ZCASH"
  !define PREV_PROD_NAME2 "Zcash-Electrum"
...
;--------------------------------
;Descriptions
LangString DESC_DE ${LANG_ENGLISH} "Zcash Electrum Wallet"
