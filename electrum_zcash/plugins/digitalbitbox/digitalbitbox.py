...
from electrum_zcash.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_zcash.bitcoin import public_key_to_p2pkh
from electrum_zcash.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, is_all_public_derivation
from electrum_zcash import ecc
from electrum_zcash.ecc import msg_magic
from electrum_zcash.wallet import Standard_Wallet
from electrum_zcash import constants
from electrum_zcash.transaction import Transaction, PartialTransaction, PartialTxInput
from electrum_zcash.i18n import _
from electrum_zcash.keystore import Hardware_KeyStore
from electrum_zcash.util import to_string, UserCancelled, UserFacingException, bfh
...
from electrum_zcash.plugin import runs_in_hwd_thread, run_in_hwd_thread
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Zcash-Electrum-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
...
class DigitalBitboxPlugin(HW_PluginBase):
    ...
    def setup_device(self, device_info, wizard, purpose):
        ...
        wizard.run_task_without_blocking_gui(
            task=lambda: client.get_xpub("m/44'/133'", 'standard'))
        return client
