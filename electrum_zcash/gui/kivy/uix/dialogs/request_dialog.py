...
from electrum_zcash.invoices import pr_tooltips, pr_color
from electrum_zcash.invoices import PR_UNKNOWN, PR_UNPAID, PR_FAILED
...
Builder.load_string('''
#:import KIVY_GUI_PATH electrum_zcash.gui.kivy.KIVY_GUI_PATH
...
class RequestDialog(Factory.Popup):
    ...
    def do_share(self):
        self.app.do_share(self.data, _("Share Zcash Request"))
        self.dismiss()
