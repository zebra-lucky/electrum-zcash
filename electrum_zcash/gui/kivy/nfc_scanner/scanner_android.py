...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.zcash.electrum.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.zcash.electrum"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.zcash.electrum:externalType",
                '',
                data)
        return extRecord
