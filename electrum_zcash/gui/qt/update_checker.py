...
from electrum_zcash.util import make_aiohttp_session, versiontuple
...
class UpdateCheck(QDialog, Logger):
    ...
    def __init__(self, *, latest_version=None):
        ...
        self.setWindowTitle('Zcash Electrum - ' + _('Update Check'))
    ...
    def update_view(self, latest_version=None):
        if latest_version:
            ...
            if self.is_newer(latest_version):
                ...
                self.detail_label.setText(_("You are already on the latest version of Zcash Electrum."))
        else:
            self.heading_label.setText('<h2>' + _("Checking for updates...") + '</h2>')
            self.detail_label.setText(_("Please wait while Zcash Electrum checks for available updates."))
