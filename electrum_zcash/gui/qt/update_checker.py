...
class UpdateCheck(QWidget, Logger):
    ...
    def __init__(self, main_window, latest_version=None):
        ...
        self.setWindowTitle('Electrum-Zcash - ' + _('Update Check'))
    ...
    def update_view(self, latest_version=None):
        if latest_version:
            ...
            if self.is_newer(latest_version):
                ...
                self.detail_label.setText(_("You are already on the latest version of Electrum-Zcash."))
        else:
            self.heading_label.setText('<h2>' + _("Checking for updates...") + '</h2>')
            self.detail_label.setText(_("Please wait while Electrum-Zcash checks for available updates."))
