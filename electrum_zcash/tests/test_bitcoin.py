...
from electrum_zcash.bitcoin import (public_key_to_p2pkh, address_from_private_key,
...
from electrum_zcash.crypto import sha256d, SUPPORTED_PW_HASH_VERSIONS
from electrum_zcash import ecc, crypto, constants
from electrum_zcash.util import bfh, bh2u, InvalidPassword, randrange
from electrum_zcash.storage import WalletStorage
from electrum_zcash.keystore import xtype_from_derivation, from_master_key

from electrum_zcash import ecc_fast
...
class Test_bitcoin(ElectrumTestCase):
    ...
    def test_msg_signing(self):
        ...
        self.assertEqual(sig2_b64, b'GyDSl0Hh8XKVDHHh+fZ7aMTPrXxxhuiG8D1QZpb79jAgGkvMrgqmNYiVuVMiT9Qyi62GWkTImLVsoj3LxVPP+PA=')
...
class Test_keyImport(ElectrumTestCase):
    ...
    priv_pub_addr = (
           ...
           {'priv': 'SzavMBLoXU6kDrqtUVmffv',
            ...
            'address': 't1V4eXN733TQhYAXQJ6Ux3oU4YprYF5dqRs',
            'minikey': True,
            'txin_type': 'p2pkh',
    ...
    def test_is_address_bad_checksums(self):
        self.assertTrue(is_address('t1QsksQt6vuyVW4SjzGMztAb7PXn6c6hNJs'))
        self.assertFalse(is_address('1819s5TxxbBtuRPr3qYskMVC8sb1pqapWw'))

        self.assertTrue(is_address('t3djLLqCvfAaAuHqw7qkUKV8yyVjxUmXWXm'))
