...
from electrum_zcash.util import (format_satoshis, format_fee_satoshis, parse_URI,
...
class TestUtil(ElectrumTestCase):
    ...
    def test_parse_URI_address(self):
        part_URI = 't1NdvKvSnnBoJ7D9nfJSX5kK7GEGNs1bY4S'
        URI = f'zcash:{part_URI}'
        self._do_test_parse_URI(
            URI, {'address': 't1NdvKvSnnBoJ7D9nfJSX5kK7GEGNs1bY4S'})
    ...
    def test_parse_URI_only_address(self):
        URI = 't1NdvKvSnnBoJ7D9nfJSX5kK7GEGNs1bY4S'
        self._do_test_parse_URI(
            URI, {'address': 't1NdvKvSnnBoJ7D9nfJSX5kK7GEGNs1bY4S'})

    def test_parse_URI_address_label(self):
        part_URI = 't1NdvKvSnnBoJ7D9nfJSX5kK7GEGNs1bY4S?label=electrum%20test'
        URI = f'zcash:{part_URI}'
        self._do_test_parse_URI(
            URI, {'address': 't1NdvKvSnnBoJ7D9nfJSX5kK7GEGNs1bY4S',
                  'label': 'electrum test'})
    ...
    def test_parse_URI_address_message(self):
        part_URI = 't1NdvKvSnnBoJ7D9nfJSX5kK7GEGNs1bY4S?message=electrum%20test'
        URI = f'zcash:{part_URI}'
        self._do_test_parse_URI(
            URI, {'address': 't1NdvKvSnnBoJ7D9nfJSX5kK7GEGNs1bY4S',
    ...
    def test_parse_URI_address_amount(self):
        part_URI = 't1NdvKvSnnBoJ7D9nfJSX5kK7GEGNs1bY4S?amount=0.0003'
        URI = f'zcash:{part_URI}'
        self._do_test_parse_URI(
            URI, {'address': 't1NdvKvSnnBoJ7D9nfJSX5kK7GEGNs1bY4S',
                  'amount': 30000})
    ...
    def test_parse_URI_ignore_args(self):
        part_URI ='t1NdvKvSnnBoJ7D9nfJSX5kK7GEGNs1bY4S?test=test'
        URI = f'zcash:{part_URI}'
        self._do_test_parse_URI(
            URI, {'address': 't1NdvKvSnnBoJ7D9nfJSX5kK7GEGNs1bY4S',
                  'test': 'test'})
